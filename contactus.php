...
<div class="wrapper col4">
  <div id="container">
    <h6>Our Address</h6>
    <p>
Online Health Consultation Management System , Kenya<br />

<strong>tel</strong>:020 65110488<br />

<strong>Email ID</strong>: ohcs@gmail.com</p>

        <h6>Contact Us by entering following information</h6>
		<form class="submitphoto_form" action="contactform.php " method="POST">
    ...
    <p class="useremail">
      <input type="text" class="wp-form-control wpcf7-email" placeholder="Enter Your Email address" name="email" id="email" required >
      <!-- <label for="email">Email</label> -->
    </p>
    
    <p class="usercontact">
      <input type="text" class="wp-form-control wpcf7-text" placeholder="Enter Subject of the message" name="contact" id="contact" required >
      <!-- <label for="contact">Phone number</label> -->
    </p>    
  
    <p class="usertext">
      <textarea class="wp-form-control wpcf7-textarea" cols="30" rows="10" placeholder="Enter Your Message Here!" name="text" requiredy ></textarea>
