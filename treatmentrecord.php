...
?>			
        ...
        <tr>
          ...
          <td><textarea name="textarea" id="textarea" cols="45" rows="5"><?php echo $rsedit[treatment_description] ; ?></textarea></td>
        </tr>
        <tr>
          <td>Treatment files</td>
          <td><input type="file" name="uploads" id="uploads" value="<?php echo $rsedit[uploads]; ?>" /></td>
        </tr>
        <tr>
          <td>Treatment date</td>
          <td><input type="date" max="<?php echo date("Y-m-d"); ?>" name="treatmentdate" id="treatmentdate" value="<?php echo $rsedit[treatment_date]; ?>" /></td>
         
        </tr>
        <tr>
          <td>Treatment Time</td>
          <td><input type="time" name="treatmenttime" id="treatmenttime" value="<?php echo $rsedit[treatment_time]; ?>" /></td>
        </tr>
        <tr>
